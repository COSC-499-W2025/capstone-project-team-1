...
from src.artifactminer.directorycrawler.directory_walk import crawl_directory,user_keep_file, user_exclude_file #getting function from directory walk
...
def test_gathered_files_from_oswalk():
    ...
    crawl_directory(mock_dir) #crawl the mock directory
